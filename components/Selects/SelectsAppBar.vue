  ...
  <v-app-bar color="indigo" prominent>
        ...
        <client-only>
          <template v-if="$vuetify.display.mdAndUp">       
             ...
             <!-- Search Field -->
    <v-text-field v-if="isSearchVisible" v-model="useComponentSearchSelectsStore().searchQuery" label="Search Types" outlined
...
const searchClear = () => {
  useComponentSearchSelectsStore().searchQuery = '';
};
