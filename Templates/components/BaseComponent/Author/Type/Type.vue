...
<script setup>
import { useMyAuthorTypeStore } from '~/stores/BaseComponent/Author/AuthorTypeBaseComponent'; //Remember to change { useMyAuthorTypeStore } to the correct store name

//Component Variables
const useStore = useMyAuthorTypeStore(); //Remember to change useMyAuthorTypeStore() to the same name as the import in { } above
