...
<template>
  ...
  <!-- Styled Button -->
  <v-card v-if="matchesSearch(cards[0])">
      ...
      <v-row align="center">
        <v-col align="center">
          <v-btn :variant="useButtonStyleStore().styled.variant" :elevation="useButtonStyleStore().styled.elevation"
            :rounded="useButtonStyleStore().styled.rounded" :color="useButtonStyleStore().styled.color"
  ...
  <!-- Activity Button -->
  <v-card v-if="matchesSearch(cards[1])">
    <v-card-title primary-title>
      {{ cards[1].title }}
    </v-card-title>
    <v-container fluid fill-height>
  ...
  <!-- Interactive Button -->
  <v-card v-if="matchesSearch(cards[2])">
    <v-card-title primary-title>
      {{ cards[2].title }}
    </v-card-title>
    <v-container fluid fill-height>
...
<!-- New Button Template -->
<!-- <v-card v-if="matchesSearch(cards[index])">
          <v-card-title primary-title>
            {{cards[index].title}}
          </v-card-title>
          <v-container fluid fill-height>
            <v-row align="center">
              <v-col align="center">
                <v-btn 
                  >
                  {{cards[index].title}} Button
                </v-btn>
              </v-col>

              <v-col cols="auto">
                <v-expansion-panels v-model="useXXXXXXXStore().panelOpen" style="max-width: 400px;"
                  position-absolute="right-0"> -->
                      ...
                      <template v-slot:default="{ expanded }">
                        <v-row no-gutters>
                          ...
                          <v-col class="text-grey" cols="8">
                            <v-fade-transition leave-absolute>
                              <span v-if="expanded" key="0">
                                Discription_When_Expanded
                              </span>
                              <span v-else key="1">
                                Discription_When_Not_Expanded
                              </span>
                            </v-fade-transition>
                          </v-col>
                        </v-row>
